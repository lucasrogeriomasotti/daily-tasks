...
class TaskCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_category" do
    assert_difference('TaskCategory.count') do
      post task_categories_url, params: { task_category: { name: @task_category.name, reference_url: @task_category.reference_url, user_id: @task_category.user_id } }
    end
  ...
  test "should update task_category" do
    patch task_category_url(@task_category), params: { task_category: { name: @task_category.name, reference_url: @task_category.reference_url, user_id: @task_category.user_id } }
