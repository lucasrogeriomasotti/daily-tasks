...
class DailyTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily_task" do
    assert_difference('DailyTask.count') do
      post daily_tasks_url, params: { daily_task: { date: @daily_task.date, duration: @daily_task.duration, name: @daily_task.name, user_id: @daily_task.user_id } }
    end
  ...
  test "should update daily_task" do
    patch daily_task_url(@daily_task), params: { daily_task: { date: @daily_task.date, duration: @daily_task.duration, name: @daily_task.name, user_id: @daily_task.user_id } }
